...
function startGame(gameType) {
    ...
    document.getElementById('user-input').disabled = false;// Kullanıcının cevabını girmesini sağlıyoruz
    ...
    remainingPasses = 3; // Pas geçme hakkı güncelleniyor
    // Oyun başladığında pas geçme butonunu etkinleştir
