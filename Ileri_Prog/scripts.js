...
const words = {
    "karisikHarfler": [
        ...
        "kimya", "biyoloji", "matematik", "geometri", "felsefe", "psikoloji", "sosyoloji", "edebiyat",
        ...
        "kepek", "kinoa", "çörekotu", "ceviz", "fındık", "badem", "kestane", 
        "zeytin", "peynir", "tereyağı", "süt", "yoğurt", "kaymak", "dondurma", "bal",
...
function updateTimer() {
    ...
    if (timeLeft <= 0) {
        ...
        const errorMessage = document.getElementById("error-message"); // Hata mesajı alanı
        errorMessage.textContent = "Süre Bitti!"; // Mesajı güncelle
        errorMessage.style.display = "block"; // Mesajı görünür yap
...
// Sonraki soruyu yükleme fonksiyonu
